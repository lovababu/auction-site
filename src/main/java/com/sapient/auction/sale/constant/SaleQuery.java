...
public final class SaleQuery {
	...
	public static final String LATEST_BID = "select bid from Bid bid where bid.sale.id = :saleId and bid.price = (select max(b.price) from Bid b where b.sale.id = :saleId)";
}
