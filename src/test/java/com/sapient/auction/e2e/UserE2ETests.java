...
public class UserE2ETests extends BaseE2ETest {
    ...
    public void testRegister() {
        AuctionResponse response = registerUser("dpadala@sapient.com");
    ...
    public void testRegisterWithExistingUserId() {
        ...
        //create user2.
        response = registerUser("dpadala@sapient.com");
    ...
    public void testLogin() {
        ...
        //Login.
        HttpEntity httpEntity = new HttpEntity(user("dpadala1@sapient.com"), httpHeaders);
    ...
    public void testLoginFailed() {
        UserVO user = user("dpadala1@sapient.com");
